...
import { StorageFileStatus } from "@/core/data/storageFile";
import DepositReportApiService from "@/core/networking/reports/depositReportApiService";
import { Button, isPDF, ScrollArea } from "yusr-ui";
            ...
            : (deposits.map((dep, i) => {
              ...
              return (
                <div
                  dir="rtl"
                  key={i}
                  className="group relative flex items-center gap-2 p-2 hover:bg-muted/30 transition-colors"
                >
