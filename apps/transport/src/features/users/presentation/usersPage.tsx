...
import { UserFilterColumns, UsersApiService } from "yusr-core";
  ...
  return (
    <CrudPage<User>
      ...
      tableRowMapper={(
        ...
        rowStyles: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${user.isActive ? "bg-green-300" : "bg-red-300"
          } text-slate-800`
      }]}
      actions={{
        filter: filterUsers,
