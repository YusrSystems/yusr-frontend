...
import VouchersApiServiceOld from "../networking/voucherApiServiceOld.ts";
...
export default class VoucherOld extends BaseEntity {
    ...
    constructor(init?: Partial<VoucherOld>) {
        super();
...
export class VoucherValidationRules {
    public static validationRules = (t: TFunction<"accounting">): ValidationRuleOld<Partial<VoucherOld>>[] => [{
        field: "type",
        selector: (d) => d.type,
...
export class VoucherSlice {
    private static entitySliceInstance = createGenericEntitySlice("voucher", new VouchersApiServiceOld());
    ...
    private static dialogSliceInstance = createGenericDialogSlice<VoucherOld>("voucherDialog");
    ...
    private static formSliceInstance = createGenericFormSlice<VoucherOld>("voucherForm");
