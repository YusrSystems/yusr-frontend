...
{
  return (
    <div className="group flex items-start gap-3 py-2.5 px-1 rounded-lg hover:bg-muted/50 transition-colors duration-150">
      ...
      <div className="max-w-lg mx-auto px-4 py-3 space-y-5">
          ...
          { setting.logo?.url
            ? (
              <div className="relative">
                <div className="w-24 h-24 rounded-full border-2 border-border shadow-md overflow-hidden bg-muted">
                  <img
            ...
            : (
              <div className="w-24 h-24 rounded-full border-2 border-border bg-muted flex items-center justify-center shadow-md">
        ...
        <SectionCard title={ t("sharing.addressInfo") }>
          <FieldRow
            ...
            value={ setting.city?.country?.name }
          />
          <FieldRow
