...
{
	if (Cubits.ItemsMovementReport.result.value == undefined)
	{
		return null;
	}
	...
	return (
		<div
			...
			{ Cubits.ItemsMovementReport.result.value.reportType === ItemsMovementReportType.ItemsMovement && (
				...
				<>
					<SummaryRow>
						...
						<SummaryRow.Value
							value={ formatNumber(Cubits.ItemsMovementReport.result.value.totalIncomeQtn) }/>
					</SummaryRow>
					<SummaryRow>
						<div>
						...
						<SummaryRow.Value
							value={ formatNumber(Cubits.ItemsMovementReport.result.value.totalOutcomeQtn) }/>
					</SummaryRow>
					<SummaryRow>
						<div>
					...
					<SummaryRow>
						...
						<SummaryRow.Value
							value={ formatNumber(Cubits.ItemsMovementReport.result.value.totalIncomeAmount) }/>
					</SummaryRow>
					<SummaryRow>
						<div>
						...
						<SummaryRow.Value
							value={ formatNumber(Cubits.ItemsMovementReport.result.value.totalOutcomeAmount) }/>
					</SummaryRow>
					<SummaryRow>
						<div>
