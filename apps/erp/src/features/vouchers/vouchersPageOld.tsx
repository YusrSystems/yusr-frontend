...
import VoucherOld, {VoucherSlice, VoucherType} from "../../core/data/voucherOld.ts";
import VouchersApiServiceOld from "../../core/networking/voucherApiServiceOld.ts";
...
export default function VouchersPageOld() {
    ...
    const service = useMemo(() => new VouchersApiServiceOld(), []);
    const [searchText, setSearchText] = useState<string | undefined>(undefined);

    return (
        <CrudPageOld<VoucherOld>
