	...
	return (
		<div className="flex items-center justify-between px-4 lg:px-6">
			<div className="flex items-center gap-4">
				<h2 className="text-2xl font-bold tracking-tight text-foreground">{ t("dashborad.overview") }</h2>
				<div
					...
					title={ t("dashborad.currencyTooltip") }
				>
					<div
						className="flex items-center justify-center rounded-full bg-primary/20 p-1 transition-transform duration-300 group-hover:rotate-12">
