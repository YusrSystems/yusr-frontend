...
import { BranchOld, BranchSlice, BranchValidationRules } from "../../entities";
...
export function ChangeBranchDialogOld({ entity, mode, service, onSuccess }: CommonChangeDialogPropsOld<BranchOld>)
{
