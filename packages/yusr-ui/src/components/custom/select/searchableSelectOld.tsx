...
export type BasicSearchableSelectParamsOld<T extends BaseEntity> = {
  items?: T[];
  selectedId?: number;
...
type SearchableSelectParamsOld<T extends BaseEntity> = BasicSearchableSelectParamsOld<T> & {
...
export function SearchableSelectOld<T extends BaseEntity>(
  {
    items = [],
    selectedId,
    selectedLabel,
