						...
						if (item.subItems && item.subItems.length > 0)
						{
							...
							>
                              ...
                              { item.title }
													...
													<ChevronLeft
														className="mr-auto transition-transform duration-200 group-data-[state=open]/collapsible:-rotate-90 ltr:rotate-180 ltr:group-data-[state=open]/collapsible:rotate-270"/>
												</SidebarMenuButton>
											</CollapsibleTrigger>
