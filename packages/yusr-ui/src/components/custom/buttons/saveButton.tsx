...
export interface SaveButtonProps<TEntity extends ChangeableEntity<TDto, TMode>, TDto extends Dto, TMode extends string = ChangeableEntityMode> {
    entity: TEntity;
...
export function SaveButton<TEntity extends ChangeableEntity<TDto, TMode>, TDto extends Dto, TMode extends string = ChangeableEntityMode>(
    {
        entity,
        service,
        label,
        ...
        onSuccess,
        transformData
    }: SaveButtonProps<TEntity, TDto, TMode>
) {
    useSignals();
