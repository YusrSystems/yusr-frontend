...
export type CrudTableHeaderPropsOld = {
  title: string;
...
export function CrudTableHeaderOld(
  {
    title,
    addButtonTitle: buttonTitle,
    changeDialog: createComp,
    isAddButtonVisible: isButtonVisible = true,
    actionButtons
  }: CrudTableHeaderPropsOld
)
{
