...
ChangeDialog.SaveButton = function <TEntity extends ChangeableEntity<TDto, TMode>, TDto extends Dto, TMode extends string = ChangeableEntityMode>(
    {...props}: SaveButtonProps<TEntity, TDto, TMode>
) {
    return <SaveButton<TEntity, TDto, TMode> {...props} />;
};
